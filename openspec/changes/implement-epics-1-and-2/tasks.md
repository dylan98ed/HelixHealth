...
- [ ] 5.4 Add professionals/test_migrations.py with an old-schema active profile, inactive profile, User links, and a linked Admission. Apply new migrations and verify IDs, flags, FKs, row counts are unchanged and new personal fields are NULL; test empty-database reverse/forward without deleting historical data.
