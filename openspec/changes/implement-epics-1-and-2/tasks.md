...
- [ ] 8.6 Add professional edit, deactivate, and reactivate forms/templates from D5, including Edit on inactive completed details to repair references or correct License number before reactivation. A completed legacy null license displays Not recorded; an untouched blank Edit control preserves it, while an explicit attempt to clear a known license is rejected. Verify confirmation errors, preserved identifiers/generated Registration number/history/activation state, rejected inactive-reference/DNI-conflicting reactivation, and visible active/inactive/incomplete states.
...
- [ ] 8.9 Add B4/B8 professional maintenance/search/pagination browser journeys, including separate License number/Registration number display, license correction, legacy Not recorded/Edit preservation, invalid edits, confirmation, denied inactive-reference/DNI-conflicting reactivation, 21-record pages, and return to saved detail. Verify `uv run pytest -m browser -q` executes these with no skipped cases.
